...
$(document).ready(function () {
	...
	$(".delete").click(function (e) {
		e.preventDefault();
        var isAdmin = confirm("Вы уверены что хотите удалить этот товар?");
        var that = $(this);
        if(isAdmin){
            $.ajax({
                type: 'GET',
                url: 'http://bybruant.kz/php/delete_product.php?id='+$(this).attr('id'),
	...
	$("#logout").click(function (e) {
        ...
        $.ajax({
            type: 'GET',
            url: 'http://bybruant.kz/php/admin_logout.php',
            success: function(data) {
	...
	$(".zakazSubmit").click(function (e) {
		...
		$.ajax({
			type: 'POST',
			url: 'http://bybruant.kz/php/mailer.php',
			data: data,
			success: function(data) {
				$("#zakaz-1").hide();
				$("#zakaz-2").show();
